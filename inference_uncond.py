...
# from models.ddim_hacked_nesterov import DDIMSampler, NesterovDDIMSampler
import cv2
import einops
import numpy as np
import os
...
parser.add_argument('--seed', type=int, default=1234)  # 添加种子参数
...
# ddim_sampler = NesterovDDIMSampler(model)
